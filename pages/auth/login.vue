<template>
	<view class="app">
		...
		<view class="input-content">
			...
			<view class="input-item">
				...
				<view class="row">
					...
					<jh-code :mobile="mobile" templateCode="MSM_1999123123"></jh-code>
				</view>
			</view>
		...
		<view class="agreement center">
			...
			<text class="tit" @click="navTo('/pages/public/agreement')">《用户服务协议》</text>
			<text class="tit" @click="navTo('/pages/public/privacy')">《隐私权政策》</text>
		</view>
	</view>
</template>
