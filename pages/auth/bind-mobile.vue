	...
	<view class="content">
		<view class="input-group">
			<view class="center">
				...
				<view class="row">
					<input v-model="mobile" class="jh-input" type="number" maxlength="11" placeholder="请输入手机号码">
				</view>
			</view>
			<view class="center">
				<text class="title">验证码：</text>
				<view class="row">
					<input v-model="code" class="jh-input" type="number" maxlength="6" placeholder="请输入验证码">
					<jh-code :mobile="mobile" templateCode="SMS_1993234234"></jh-code>
				</view>
			</view>
		</view>
