<template>
	<view class="course-play">
		<!-- #ifndef APP-PLUS -->
		<video id="myVideo" style="width: 750rpx; height: 423rpx;" :poster="videoMidea.mainImage"
			:src="videoMidea.videoUrl"></video>
		<!-- #endif -->
		...
		<!-- 课程列表 -->
		<course-dir :isBuy="true"></course-dir>
